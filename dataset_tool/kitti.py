...
from dataset_tool.imdb import imdb
from lib.utils.util import bbox_transform_inv, batch_iou
...
class kitti(imdb):
    def __init__(self, image_set, data_path, mc):
        ...
        self._eval_tool = './dataset_tool/kitti-eval/cpp/evaluate_object'
...
if __name__ == '__main__':
    ...
    ds = tf.data.Dataset.from_generator(imdb.next_batch, (tf.float32, tf.float32, tf.float32,
